...
export namespace proto {
    ...
    /** Represents a battleFrameAllReq. */
    class battleFrameAllReq implements IbattleFrameAllReq {

        /**
         * Constructs a new battleFrameAllReq.
         * @param [properties] Properties to set
         */
        constructor(properties?: proto.IbattleFrameAllReq);

        /** battleFrameAllReq clientFrame. */
        public clientFrame: number;

        /**
         * Creates a new battleFrameAllReq instance using the specified properties.
         * @param [properties] Properties to set
         * @returns battleFrameAllReq instance
         */
        public static create(properties?: proto.IbattleFrameAllReq): proto.battleFrameAllReq;

        /**
         * Encodes the specified battleFrameAllReq message. Does not implicitly {@link proto.battleFrameAllReq.verify|verify} messages.
         * @param message battleFrameAllReq message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: proto.IbattleFrameAllReq, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: proto.IbattleFrameAllReq, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a battleFrameAllReq message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns battleFrameAllReq
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): proto.battleFrameAllReq;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): proto.battleFrameAllReq;
         ...
         * @returns battleFrameAllReq
         */
        public static fromObject(object: { [k: string]: any }): proto.battleFrameAllReq;

        /**
         * Creates a plain object from a battleFrameAllReq message. Also converts values to other types if specified.
         * @param message battleFrameAllReq
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: proto.battleFrameAllReq, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    /** Represents a battleFrameAllResp. */
    class battleFrameAllResp implements IbattleFrameAllResp {

        /**
         * Constructs a new battleFrameAllResp.
         * @param [properties] Properties to set
         */
        constructor(properties?: proto.IbattleFrameAllResp);
         ...
         * @param [properties] Properties to set
         * @returns battleFrameAllResp instance
         */
        public static create(properties?: proto.IbattleFrameAllResp): proto.battleFrameAllResp;
         ...
         * @param message battleFrameAllResp message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: proto.IbattleFrameAllResp, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: proto.IbattleFrameAllResp, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a battleFrameAllResp message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns battleFrameAllResp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): proto.battleFrameAllResp;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): proto.battleFrameAllResp;
         ...
         * @returns battleFrameAllResp
         */
        public static fromObject(object: { [k: string]: any }): proto.battleFrameAllResp;

        /**
         * Creates a plain object from a battleFrameAllResp message. Also converts values to other types if specified.
         * @param message battleFrameAllResp
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: proto.battleFrameAllResp, options?: $protobuf.IConversionOptions): { [k: string]: any };
